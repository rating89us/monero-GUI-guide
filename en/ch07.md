...
Transactions with 0 confirmations are displayed as `Pending`. These transactions were added to the mempool, but they have not yet been included in a block by a miner.  
